...
export function NewsletterCta() {
  ...
  return (
    <div className="flex flex-col gap-2.5 rounded-md bg-brand p-4 sm:p-[18px]">
      <span className="font-display text-[15px] font-bold tracking-[0.06em] text-white">THE MZ BRIEFING</span>
      <p className="font-body text-xs leading-relaxed text-[#ffd9de]">
        Daily email. Every Madrid story that matters.
      </p>
      {status === "submitted" ? (
