...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex w-[50px] flex-none cursor-pointer items-center justify-center gap-1 whitespace-nowrap rounded-full border-[1.5px] border-accent-border py-1.5 font-display text-[8.5px] font-bold tracking-wide text-accent transition-colors hover:border-brand hover:bg-brand/10 sm:w-[90px] sm:gap-1.5 sm:py-2 sm:text-[11px]"
    >
