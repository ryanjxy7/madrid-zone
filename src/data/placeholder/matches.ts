...
export const placeholderUpcoming: Fixture[] = [
  { id: "up-1", opponent: "Real Betis", competition: "US Tour · Chicago", date: "Jul 26" },
...
export const placeholderResults: MatchResult[] = [
  { id: "res-1", match: "Real Madrid 3–1 Barcelona", competition: "CWC Semi-final", outcome: "W" },
  { id: "res-2", match: "Real Madrid 2–0 Opponent", competition: "CWC Quarter-final", outcome: "W" },
  { id: "res-3", match: "Atlético 1–1 Real Madrid", competition: "CWC Group", outcome: "D" },
  { id: "res-4", match: "Real Madrid 4–0 Real Betis", competition: "CWC Group", outcome: "W" },
];
