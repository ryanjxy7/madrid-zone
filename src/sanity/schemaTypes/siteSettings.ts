...
export const siteSettings = defineType({
  ...
  groups: [
    ...
    { name: "transfers", title: "Transfer Centre" },
  ...
  fields: [
    ...
    defineField({
      name: "transferTotalSpent",
      title: "Total spent this window",
      type: "string",
      description: "e.g. \"€126m\"",
      group: "transfers",
    }),
    defineField({
      name: "transferSpentNote",
      title: "Total spent — subtext",
      type: "string",
      description: "e.g. \"3 signings this window\"",
      group: "transfers",
    }),
    defineField({
      name: "transferTotalSales",
      title: "Total sales this window",
      type: "string",
      description: "e.g. \"€80m\"",
      group: "transfers",
    }),
    defineField({
      name: "transferSalesNote",
      title: "Total sales — subtext",
      type: "string",
      description: "e.g. \"2 departures, 1 loan out\"",
      group: "transfers",
    }),
    defineField({
      name: "managerName",
